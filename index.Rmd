...
**Data** used in the workshops can be found on the GeoDa Center [data website](https://geodacenter.github.io/data-and-lab/), or will be linked to in each workshop chapter. All data will eventually be found in an R package developed by the CSDS.
